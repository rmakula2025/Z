...
ALLOWED_HOSTS = [
    "z-backend-5cdi.onrender.com",   # ✅ new backend Render URL
    "z-frontend-y43g.onrender.com",  # ✅ new frontend Render URL
    "localhost",
    "127.0.0.1"
]
...
# Database (SQLite for Django, MongoDB for your data)
DATABASES = {
    "default": {
...
# ✅ Update CORS to allow new frontend
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",                  # Local dev
    "https://z-frontend-y43g.onrender.com",   # ✅ new frontend Render URL
]
